      ...
      <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#fafaf8' }}>
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-semibold text-gray-900">SettleWell</h1>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <h2 className="text-lg font-medium text-gray-900 mb-6">{currentQuestion.q}</h2>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#fafaf8' }}>
        <div className="w-full max-w-2xl max-h-screen overflow-y-auto">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <h1 className="text-2xl font-semibold text-gray-900 mb-6">Your Action Plan</h1>
