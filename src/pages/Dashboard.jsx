    ...
    <div className="p-6 max-w-5xl">
      ...
      <div className="mb-6">
        <div className="flex items-baseline gap-3 flex-wrap">
          <h1 className="text-2xl font-semibold text-gray-900">{currentEstate.deceased_name}</h1>
          <span className="text-sm text-gray-400">Died {dod} · {days} days ago · {currentEstate.state_of_residence}</span>
        </div>
        <div className="text-sm text-gray-500 mt-0.5">Executor: {currentEstate.administrator_name}</div>
      </div>
