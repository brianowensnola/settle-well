...
export default function DocumentUpload() {
  ...
  return (
    <div className="p-6 max-w-4xl">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">Bulk Document Upload</h1>
        <p className="text-sm text-gray-500 mt-1">Upload all your PDFs, photos, and documents at once</p>
      </div>
